...
# Libraries
################################################################################
::legacy::set_attribute library {/mnt/apps/prebuilt/eda/designkits/GPDK/gsclib045/lan/flow/t1u1/reference_libs/GPDK045/gsclib045_svt_v4.4/gsclib045/timing/slow_vdd1v2_basicCells.lib} /
...
if {$_cell_area_ != "37368"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 37368,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "15206"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 15206,  current net area: $_net_area_"
}
unset _net_area_
