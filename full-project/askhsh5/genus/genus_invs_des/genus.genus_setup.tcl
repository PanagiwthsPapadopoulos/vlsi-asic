...
if {$_slk_ != "1032.8"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 1032.8,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "29517"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 29517,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "12538"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 12538,  current net area: $_net_area_"
}
unset _net_area_
