...
if {$_slk_ != "7.0"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 7.0,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "34943"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 34943,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "14126"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 14126,  current net area: $_net_area_"
}
unset _net_area_
