...
# Generated on: Wed Dec 03 19:16:58 EET 2025 (Wed Dec 03 17:16:58 UTC 2025)
...
set logfile rtl_vs_elab.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information rtl_picorv32_elabv_db
...
read_implementation_information fv/picorv32_wb -revised picorv32_elabv
...
read_design -verilog95   -revised -lastmod -noelab picorv32_elab.v
...
#add_name_alias fv/picorv32_wb/picorv32_elabv.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.picorv32_wb.rtl.picorv32_elabv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.picorv32_wb.rtl.picorv32_elabv.rpt
}
report_test_vector -noneq > noneq.test_vector.picorv32_wb.rtl.picorv32_elabv.rpt
