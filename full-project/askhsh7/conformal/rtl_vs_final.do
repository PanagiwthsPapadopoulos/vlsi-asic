...
# Generated on: Wed Dec 03 19:24:42 EET 2025 (Wed Dec 03 17:24:42 UTC 2025)
...
set logfile rtl_vs_final.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information fv_map_picorv32_finalv_db

read_implementation_information fv/picorv32_wb -golden fv_map -revised picorv32_finalv
...
read_design -verilog95   -golden -lastmod -noelab fv/picorv32_wb/fv_map.v.gz
elaborate_design -golden -root {picorv32_wb}

read_design -verilog95   -revised -lastmod -noelab picorv32_final.v
elaborate_design -revised -root {picorv32_wb}

#add_name_alias fv/picorv32_wb/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/picorv32_wb/picorv32_finalv.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.picorv32_wb.fv_map.picorv32_finalv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.picorv32_wb.fv_map.picorv32_finalv.rpt
}
report_test_vector -noneq > noneq.test_vector.picorv32_wb.fv_map.picorv32_finalv.rpt
...
read_implementation_information fv/picorv32_wb -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/p/ppapadoe/Desktop/vlsi-asic/picorv32.v
elaborate_design -golden -root {picorv32_wb} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/picorv32_wb/fv_map.v.gz
elaborate_design -revised -root {picorv32_wb}
...
#add_name_alias fv/picorv32_wb/fv_map.singlebit.original_name.alias.json.gz -revised
#set_mapping_method -alias -revised
#add_renaming_rule r1alias _reg((\\\[%w\\\])*(/U\\\$%d)*)$ @1 -type dff dlat -both
...
write_hier_compare_dofile hier_tmp5.lec.do -verbose -noexact_pin_match -constraint -usage \
...
run_hier_compare hier_tmp5.lec.do -dynamic_hierarchy
...
set_system_mode lec
write_compared_points noneq.compared_points.picorv32_wb.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.picorv32_wb.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.picorv32_wb.rtl.fv_map.rpt
