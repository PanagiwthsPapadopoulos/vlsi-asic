...
# Generated on: Wed Dec 03 19:23:55 EET 2025 (Wed Dec 03 17:23:55 UTC 2025)
...
set logfile rtl_vs_mapped.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information fv_map_picorv32_mappedv_db

read_implementation_information fv/picorv32_wb -golden fv_map -revised picorv32_mappedv
...
read_design -verilog95   -revised -lastmod -noelab picorv32_mapped.v
...
#add_name_alias fv/picorv32_wb/picorv32_mappedv.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.picorv32_wb.fv_map.picorv32_mappedv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.picorv32_wb.fv_map.picorv32_mappedv.rpt
}
report_test_vector -noneq > noneq.test_vector.picorv32_wb.fv_map.picorv32_mappedv.rpt
