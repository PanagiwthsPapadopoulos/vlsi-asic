################################################################################
# INNOVUS IMPLEMENTATION SCRIPT - TASK 1 (STANDARD FLOW)
...
# Setup Optimization Mode (High Timing, No Power for Task 1)
setPlaceMode -reset
...
# ------------------------------------------------------------------------------
# STEP 12: EARLY POWER RAIL ANALYSIS
# ------------------------------------------------------------------------------

# Analyze manually from GUI

# ------------------------------------------------------------------------------
# STEP 13: EARLY GLOBAL ROUTE (Congestion Check)
# ------------------------------------------------------------------------------
...
report_power > reports/power_all_metals.rpt
report_area > reports/area_all_metals.rpt

# Check 2: Limited Metals (M5-M10)
reportCongestion -hotspot > reports/congestion_limited_metals.rpt
reportNetStat > reports/net_stat_limited_metals.rpt
report_route -summary > reports/egr_limited_metals.rpt
report_power > reports/power_limited_metals.rpt
report_area > reports/area_limited_metals.rpt
