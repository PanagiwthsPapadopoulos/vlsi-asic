...
create_constraint_mode -name constraint1\
   -sdc_files\
    [list ${::IMEX::dataVar}/mmmc/modes/constraint1/constraint1.sdc]
create_analysis_view -name analysis1 -constraint_mode constraint1 -delay_corner delay1 -latency_file ${::IMEX::dataVar}/mmmc/views/analysis1/latency.sdc
