...
# Set the elaborated design as the current working design
...
# Enable high effort for power optimization [cite: 230-232]
# This tells Genus to apply algorithms specifically for power saving.
set_db design_power_effort high

# Focus specifically on Dynamic Power [cite: 233]
# 0.0 = Optimization focuses only on Dynamic Power
# 1.0 = Optimization focuses only on Leakage Power
# Since Task 2 asks for "minimum dynamic power", set this to 0.0.
...
# Prevent Genus from swapping normal DFFs with SDFFs
