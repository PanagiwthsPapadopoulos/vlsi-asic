...
if {$_slk_ != "986.4"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 986.4,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "35261"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 35261,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "15253"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 15253,  current net area: $_net_area_"
}
unset _net_area_
